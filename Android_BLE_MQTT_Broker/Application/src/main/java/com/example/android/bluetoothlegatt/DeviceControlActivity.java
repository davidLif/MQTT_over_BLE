...
public class DeviceControlActivity extends Activity {
    ...
    private final BroadcastReceiver mGattUpdateReceiver = new BroadcastReceiver() {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            if (BluetoothLeService.ACTION_GATT_CONNECTED.equals(action)) {
                ...
                //String bleReceviedStr = intent.getStringExtra(BluetoothLeService.EXTRA_DATA);
                ...
                public boolean onChildClick(ExpandableListView parent, View v, int groupPosition,
                    ...
                    if (mGattCharacteristics != null) {
                        ...
                        if ((charaProp & BluetoothGattCharacteristic.PROPERTY_WRITE) > 0) {
                            ...
                            final EditText userWritingInput = new EditText(DeviceControlActivity.this);
                            userWritingInput.setInputType(InputType.TYPE_CLASS_TEXT);

                            AlertDialog alertDialog = new AlertDialog.Builder(DeviceControlActivity.this).create();
                            alertDialog.setTitle("BLE write");
                            alertDialog.setMessage("Write a value to the current characteristic");
                            alertDialog.setView(userWritingInput);
                            // Set up the buttons
                            alertDialog.setButton(AlertDialog.BUTTON_POSITIVE, "Text", new DialogInterface.OnClickListener() {
                                @Override
                                public void onClick(DialogInterface dialog, int which) {
                                    String m_Text = userWritingInput.getText().toString();
                                    characteristic.setValue(m_Text);
                                    mBluetoothLeService.writeCharacteristic(characteristic);
                                    dialog.dismiss();
                                }
                            });
                            alertDialog.setButton(AlertDialog.BUTTON_NEUTRAL,"Byte hex", new DialogInterface.OnClickListener() {
                                @Override
                                public void onClick(DialogInterface dialog, int which) {
                                    byte[] byteInput = hexStringToByteArray(userWritingInput.getText().toString());
                                    characteristic.setValue(byteInput);
                                    mBluetoothLeService.writeCharacteristic(characteristic);
                                    dialog.dismiss();
                                }
                            });
    ...
    private void displayGattServices(List<BluetoothGattService> gattServices) {
        ...
        for (BluetoothGattService gattService : gattServices) {
            ...
            ArrayList<BluetoothGattCharacteristic> charasLst =
                    new ArrayList<>();

            // Loops through available Characteristics.
            for (BluetoothGattCharacteristic gattCharacteristic : gattCharacteristics) {
                charasLst.add(gattCharacteristic);
            ...
            mGattCharacteristics.add(charasLst);
