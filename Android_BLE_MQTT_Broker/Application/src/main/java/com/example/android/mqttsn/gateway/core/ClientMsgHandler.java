...
package com.example.android.mqttsn.gateway.core;

import com.example.android.mqttsn.gateway.broker.tcp.TCPBrokerInterface;
import com.example.android.mqttsn.gateway.client.ClientInterface;
...
import com.example.android.mqttsn.gateway.messages.mqtt.MqttConnack;
import com.example.android.mqttsn.gateway.messages.mqtt.MqttConnect;
import com.example.android.mqttsn.gateway.messages.mqtt.MqttDisconnect;
import com.example.android.mqttsn.gateway.messages.mqtt.MqttMessage;
import com.example.android.mqttsn.gateway.messages.mqtt.MqttPingReq;
import com.example.android.mqttsn.gateway.messages.mqtt.MqttPingResp;
import com.example.android.mqttsn.gateway.messages.mqtt.MqttPubComp;
import com.example.android.mqttsn.gateway.messages.mqtt.MqttPubRec;
import com.example.android.mqttsn.gateway.messages.mqtt.MqttPubRel;
import com.example.android.mqttsn.gateway.messages.mqtt.MqttPuback;
import com.example.android.mqttsn.gateway.messages.mqtt.MqttPublish;
import com.example.android.mqttsn.gateway.messages.mqtt.MqttSuback;
import com.example.android.mqttsn.gateway.messages.mqtt.MqttSubscribe;
import com.example.android.mqttsn.gateway.messages.mqtt.MqttUnsuback;
import com.example.android.mqttsn.gateway.messages.mqtt.MqttUnsubscribe;
import com.example.android.mqttsn.gateway.messages.mqtts.MqttsConnack;
import com.example.android.mqttsn.gateway.messages.mqtts.MqttsConnect;
import com.example.android.mqttsn.gateway.messages.mqtts.MqttsDisconnect;
import com.example.android.mqttsn.gateway.messages.mqtts.MqttsMessage;
import com.example.android.mqttsn.gateway.messages.mqtts.MqttsPingReq;
import com.example.android.mqttsn.gateway.messages.mqtts.MqttsPingResp;
import com.example.android.mqttsn.gateway.messages.mqtts.MqttsPubComp;
import com.example.android.mqttsn.gateway.messages.mqtts.MqttsPubRec;
import com.example.android.mqttsn.gateway.messages.mqtts.MqttsPubRel;
import com.example.android.mqttsn.gateway.messages.mqtts.MqttsPuback;
import com.example.android.mqttsn.gateway.messages.mqtts.MqttsPublish;
import com.example.android.mqttsn.gateway.messages.mqtts.MqttsRegack;
import com.example.android.mqttsn.gateway.messages.mqtts.MqttsRegister;
import com.example.android.mqttsn.gateway.messages.mqtts.MqttsSearchGW;
import com.example.android.mqttsn.gateway.messages.mqtts.MqttsSuback;
import com.example.android.mqttsn.gateway.messages.mqtts.MqttsSubscribe;
import com.example.android.mqttsn.gateway.messages.mqtts.MqttsUnsuback;
import com.example.android.mqttsn.gateway.messages.mqtts.MqttsUnsubscribe;
import com.example.android.mqttsn.gateway.messages.mqtts.MqttsWillMsg;
import com.example.android.mqttsn.gateway.messages.mqtts.MqttsWillMsgReq;
import com.example.android.mqttsn.gateway.messages.mqtts.MqttsWillMsgUpd;
import com.example.android.mqttsn.gateway.messages.mqtts.MqttsWillTopic;
import com.example.android.mqttsn.gateway.messages.mqtts.MqttsWillTopicReq;
import com.example.android.mqttsn.gateway.messages.mqtts.MqttsWillTopicUpd;
import com.example.android.mqttsn.gateway.timer.TimerService;
import com.example.android.mqttsn.gateway.utils.ClientAddress;
...
import com.example.android.mqttsn.gateway.utils.Utils;
...
public class ClientMsgHandler extends MsgHandler{
	...
	/* (non-Javadoc)
	 * @see com.example.android.mqttsn.gateway.core.MsgHandler#initialize()
	 */
	...
	/* (non-Javadoc)
	 * @see com.example.android.mqttsn.gateway.core.MsgHandler#handleMqttsMessage(com.example.android.mqttsn.gateway.messages.mqtts.MqttsMessage)
	 */
	...
	private void handleMqttsSearchGW(MqttsSearchGW receivedMsg) {		
		...
		//construct an "internal" message (see com.example.android.mqttsn.gateway.messages.Message)
	...
	private void handleMqttsPublish(MqttsPublish receivedMsg) {
		...
		//if Mqtts PUBLISH message has QoS = -1, construct an "internal" message (see com.example.android.mqttsn.gateway.core.Message)
		//for the GatewayMsgHandler and put it to the dispatcher's queue 
	...
	/* (non-Javadoc)
	 * @see com.example.android.mqttsn.gateway.core.MsgHandler#handleMqttMessage(com.example.android.mqttsn.gateway.messages.mqtt.MqttMessage)
	 */
	...
	/* (non-Javadoc)
	 * @see com.example.android.mqttsn.gateway.core.MsgHandler#handleControlMessage(com.example.android.mqttsn.gateway.messages.control.ControlMessage)
	 */
