...
package mqttsnGateway.gateway.client.udp;
...
//import mqttsnGateway.gateway.client.udp.UDPClientInterface.Forwarder;
import mqttsnGateway.gateway.core.Dispatcher;
import mqttsnGateway.gateway.exceptions.MqttsException;
import mqttsnGateway.gateway.messages.Message;
import mqttsnGateway.gateway.messages.mqtts.MqttsAdvertise;
import mqttsnGateway.gateway.messages.mqtts.MqttsConnect;
import mqttsnGateway.gateway.messages.mqtts.MqttsDisconnect;
import mqttsnGateway.gateway.messages.mqtts.MqttsGWInfo;
 ...
 * interface {@link mqttsnGateway.gateway.client.ClientInterface}.
...
public class UDPClientInterface implements ClientInterface, Runnable {
	...
	/* (non-Javadoc)
	 * @see mqttsnGateway.gateway.client.ClientInterface#broadcastMsg(mqttsnGateway.gateway.messages.mqtts.MqttsMessage)
	 */
	...
	/* (non-Javadoc)
	 * @see mqttsnGateway.gateway.client.ClientInterface#broadcastMsg(int, mqttsnGateway.gateway.messages.mqtts.MqttsMessage)
	 */
	...
	/* (non-Javadoc)
	 * @see mqttsnGateway.gateway.client.ClientInterface#readMsg()
	 */
	public void readMsg() {
...
//			}
	 ...
	 * general "internal" message {@link mqttsnGateway.gateway.messages.Message}
	 * which puts it to Dispatcher's queue {@link  mqttsnGateway.gateway.core.Dispatcher.
	 * 
	...
	/* (non-Javadoc)
	 * @see mqttsnGateway.gateway.client.ClientInterface#sendMsg(mqttsnGateway.gateway.utils.SAaddress, mqttsnGateway.gateway.messages.mqtts.MqttsMessage)
	 */
