...
import mqttsnGateway.gateway.core.GatewayMsgHandler;
...
import mqttsnGateway.gateway.utils.ConfigurationParser;
...
public class Gateway {
	...
	public void StartOnDifferentThread(Context context) {
		...
		try {
			ConfigurationParser.parseGatewayConfig(context);
		...
		new Thread() {
			public void run() {
				...
				//create the address of the gateway itself(see mqttsnGateway.gateway.utils.GatewayAdress)
