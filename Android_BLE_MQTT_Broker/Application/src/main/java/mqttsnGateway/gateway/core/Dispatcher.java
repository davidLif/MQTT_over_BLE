...
import mqttsnGateway.gateway.utils.MsgQueue;
...
public class Dispatcher implements Runnable{
	...
	/**
	 * The method that reads a message {@link mqttsnGateway.gateway.messages.Message} from
	...
	/**
	 * The method that puts a message {@link mqttsnGateway.gateway.messages.Message}
	 * to the queue.
	 * 
	 * @param msg
	 */
