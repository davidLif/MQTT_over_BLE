...
package mqttsnGateway.gateway.core;

import mqttsnGateway.gateway.broker.tcp.TCPBrokerInterface;
import mqttsnGateway.gateway.client.ClientInterface;
import mqttsnGateway.gateway.exceptions.MqttsException;
import mqttsnGateway.gateway.messages.Message;
import mqttsnGateway.gateway.messages.control.ControlMessage;
import mqttsnGateway.gateway.messages.mqtt.MqttConnack;
import mqttsnGateway.gateway.messages.mqtt.MqttConnect;
import mqttsnGateway.gateway.messages.mqtt.MqttDisconnect;
import mqttsnGateway.gateway.messages.mqtt.MqttMessage;
import mqttsnGateway.gateway.messages.mqtt.MqttPingReq;
import mqttsnGateway.gateway.messages.mqtt.MqttPingResp;
import mqttsnGateway.gateway.messages.mqtt.MqttPubComp;
import mqttsnGateway.gateway.messages.mqtt.MqttPubRec;
import mqttsnGateway.gateway.messages.mqtt.MqttPubRel;
import mqttsnGateway.gateway.messages.mqtt.MqttPuback;
import mqttsnGateway.gateway.messages.mqtt.MqttPublish;
import mqttsnGateway.gateway.messages.mqtt.MqttSuback;
import mqttsnGateway.gateway.messages.mqtt.MqttSubscribe;
import mqttsnGateway.gateway.messages.mqtt.MqttUnsuback;
import mqttsnGateway.gateway.messages.mqtt.MqttUnsubscribe;
import mqttsnGateway.gateway.messages.mqtts.MqttsConnack;
import mqttsnGateway.gateway.messages.mqtts.MqttsConnect;
import mqttsnGateway.gateway.messages.mqtts.MqttsDisconnect;
import mqttsnGateway.gateway.messages.mqtts.MqttsMessage;
import mqttsnGateway.gateway.messages.mqtts.MqttsPingReq;
import mqttsnGateway.gateway.messages.mqtts.MqttsPingResp;
import mqttsnGateway.gateway.messages.mqtts.MqttsPubComp;
import mqttsnGateway.gateway.messages.mqtts.MqttsPubRec;
import mqttsnGateway.gateway.messages.mqtts.MqttsPubRel;
import mqttsnGateway.gateway.messages.mqtts.MqttsPuback;
import mqttsnGateway.gateway.messages.mqtts.MqttsPublish;
import mqttsnGateway.gateway.messages.mqtts.MqttsRegack;
import mqttsnGateway.gateway.messages.mqtts.MqttsRegister;
import mqttsnGateway.gateway.messages.mqtts.MqttsSearchGW;
import mqttsnGateway.gateway.messages.mqtts.MqttsSuback;
import mqttsnGateway.gateway.messages.mqtts.MqttsSubscribe;
import mqttsnGateway.gateway.messages.mqtts.MqttsUnsuback;
import mqttsnGateway.gateway.messages.mqtts.MqttsUnsubscribe;
import mqttsnGateway.gateway.messages.mqtts.MqttsWillMsg;
import mqttsnGateway.gateway.messages.mqtts.MqttsWillMsgReq;
import mqttsnGateway.gateway.messages.mqtts.MqttsWillMsgUpd;
import mqttsnGateway.gateway.messages.mqtts.MqttsWillTopic;
import mqttsnGateway.gateway.messages.mqtts.MqttsWillTopicReq;
import mqttsnGateway.gateway.messages.mqtts.MqttsWillTopicUpd;
import mqttsnGateway.gateway.timer.TimerService;
import mqttsnGateway.gateway.utils.ClientAddress;
import mqttsnGateway.gateway.utils.GWParameters;
import mqttsnGateway.gateway.utils.GatewayAddress;
import mqttsnGateway.gateway.utils.GatewayLogger;
import mqttsnGateway.gateway.utils.Utils;
...
public class ClientMsgHandler extends MsgHandler{
	...
	/* (non-Javadoc)
	 * @see mqttsnGateway.gateway.core.MsgHandler#initialize()
	 */
	...
	/* (non-Javadoc)
	 * @see mqttsnGateway.gateway.core.MsgHandler#handleMqttsMessage(mqttsnGateway.gateway.messages.mqtts.MqttsMessage)
	 */
	...
	private void handleMqttsSearchGW(MqttsSearchGW receivedMsg) {		
		...
		//construct an "internal" message (see mqttsnGateway.gateway.messages.Message)
	...
	private void handleMqttsPublish(MqttsPublish receivedMsg) {
		...
		//if Mqtts PUBLISH message has QoS = -1, construct an "internal" message (see mqttsnGateway.gateway.core.Message)
		//for the GatewayMsgHandler and put it to the dispatcher's queue 
	...
	/* (non-Javadoc)
	 * @see mqttsnGateway.gateway.core.MsgHandler#handleMqttMessage(mqttsnGateway.gateway.messages.mqtt.MqttMessage)
	 */
	...
	/* (non-Javadoc)
	 * @see mqttsnGateway.gateway.core.MsgHandler#handleControlMessage(mqttsnGateway.gateway.messages.control.ControlMessage)
	 */
